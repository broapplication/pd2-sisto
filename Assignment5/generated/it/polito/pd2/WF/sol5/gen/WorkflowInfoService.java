    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(it.polito.pd2.WF.sol5.gen.WorkflowInfoService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = it.polito.pd2.WF.sol5.gen.WorkflowInfoService.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:8181/WorkflowInfoService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8181/WorkflowInfoService?wsdl', retrying as a local file");
    ...
    public WorkflowInfoService() {
        super(WORKFLOWINFOSERVICE_WSDL_LOCATION, new QName("http://pad.polito.it/WorkflowInfo", "WorkflowInfoService"));
    }
