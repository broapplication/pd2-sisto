...
public interface ProcessPortType {
     ...
     * @param actor
     * @return
     *     returns it.polito.pd2.WF.sol6.client1.gen.ActionStatusType
    ...
    @RequestWrapper(localName = "takeInCharge", targetNamespace = "http://pad.polito.it/Workflow", className = "it.polito.pd2.WF.sol6.client1.gen.TakeInCharge")
    @ResponseWrapper(localName = "takeInChargeResponse", targetNamespace = "http://pad.polito.it/Workflow", className = "it.polito.pd2.WF.sol6.client1.gen.TakeInChargeResponse")
    ...
    @RequestWrapper(localName = "terminateAction", targetNamespace = "http://pad.polito.it/Workflow", className = "it.polito.pd2.WF.sol6.client1.gen.TerminateAction")
    @ResponseWrapper(localName = "terminateActionResponse", targetNamespace = "http://pad.polito.it/Workflow", className = "it.polito.pd2.WF.sol6.client1.gen.TerminateActionResponse")
